  ...
  Widget build(BuildContext context) {
    InputDecoration textFormFieldDecoration(String hintText) {
      return InputDecoration(
        ...
        filled: true,
        hintStyle:
            TextStyle(fontSize: 14, fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.neutralGray03),
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          elevation: 1,
          iconTheme: IconThemeData(color: Theme.of(context).colorScheme.accentBlue02),
          backgroundColor: Theme.of(context).colorScheme.neutralWhite01,
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text('Got a suggestion or complaint? Give us a message! We appreciate and feedback.',
                        textAlign: TextAlign.center,
                        style: Theme.of(context).textTheme.bodyText2?.copyWith(
                            fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.neutralGray04)),
                  ),
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: textFormFieldDecoration('Enter your message here'),
                      ),
                    ),
                  ]),
                ],
  ...
  Future<void> sendMessage() async {
    ...
    Get.defaultDialog(
      ...
      titleStyle: Theme.of(context)
          .textTheme
          .headline5
          ?.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.sunflowerYellow01),
      ...
      content: Column(
        children: [
          ...
          Container(
              ...
              child: Text(
                  'Your feedback is very appreciated! A response will be sent to you if deemed necessary. Thank you!',
                  textAlign: TextAlign.center,
                  style: Theme.of(context)
                      .textTheme
                      .bodyText1
