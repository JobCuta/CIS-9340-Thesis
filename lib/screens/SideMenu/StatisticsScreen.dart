...
class _StatisticsScreenState extends State<StatisticsScreen> {
  ...
  Widget build(BuildContext context) {
    List<EmotionEntryHive> emotionEntry = _emotionController.getEmotionEntriesForMonth(month, year);
                        ...
                        text: TextSpan(children: [
                            WidgetSpan(
                              ...
                              child: Icon(Icons.emoji_events_outlined,
                                  color: Theme.of(context).colorScheme.sunflowerYellow03,
                                  size: 28.0)),
                          TextSpan(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image(image: moodMap['VeryBad']!.icon, width: 42.0),
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image(image: moodMap['Neutral']!.icon, width: 42.0),
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image(image: moodMap['Happy']!.icon, width: 42.0),
                            ...
                            Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Image(image: moodMap['VeryHappy']!.icon, width: 42.0),
                        ...
                        Text('Total moods: ' + (_emotionController.monthMoodCount[0] + _emotionController.monthMoodCount[1] + _emotionController.monthMoodCount[2] +
                            _emotionController.monthMoodCount[3] + _emotionController.monthMoodCount[4]).toString(),
        
                            style: Theme.of(context).textTheme.bodyText1?.copyWith(color: Theme.of(context).colorScheme.neutralGray02)
                        ),
                      ],
                    ),
                  ),
