...
class _StatisticsScreenState extends State<StatisticsScreen> {
  ...
  late List<EmotionEntryHive> latestEmotionEntries = _emotionController.getEmotionEntriesInTheLastDays(7);
  int month = DateTime.now().month;
  int year = DateTime.now().year;
  int currentWeekDay = DateTime.now().weekday;
  Map<int, String> weekdayString = {1: 'Mon', 2: 'Tue', 3: 'Wed', 4: 'Thu', 5: 'Fri', 6: 'Sat', 7: 'Sun'};
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                      ...
                      children: [
                        Text(
                          ...
                          style: Theme.of(context).textTheme.subtitle2?.copyWith(
                              color: Theme.of(context).colorScheme.neutralBlack02, fontWeight: FontWeight.w600),
                        ),
                                ...
                                itemBuilder: (context, index) {
                                  return Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        latestEmotionEntries[index].overallMood != 'NoData'
                                            ? SvgPicture.asset('assets/images/blue_checkmark.svg', width: 30)
                                            : SvgPicture.asset('assets/images/gray_x.svg', width: 32),
                                        Text((latestEmotionEntries[index].weekday).substring(0, 3),
                        ...
                        Center(
                          child: Text(
                            _emotionController.currentStreak.value.toString() +
                                ' ' +
                                ((_emotionController.currentStreak.value > 1) ? 'days' : 'day') +
                                ' in a row',
                            ...
                            WidgetSpan(
                                ...
                                child: Padding(
                                  ...
                                  child: Icon(Icons.emoji_events_outlined,
                                      color: Theme.of(context).colorScheme.sunflowerYellow03, size: 28.0),
                                )),
                            TextSpan(
                                text: 'Longest chain: ${_emotionController.longestStreak.value}',
                                style: Theme.of(context).textTheme.bodyText2?.copyWith(
                              ...
                              Column(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Image(image: moodMap['VeryBad']!.icon, width: 42.0),
                                  ),
                                  Text('${_emotionController.monthMoodCount[0]}',
                                      style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: Theme.of(context).colorScheme.moodVeryBad)),
                                ],
                              ),
                              Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 5),
                                    child: Image(image: moodMap['Bad']!.icon, width: 42.0),
                                  ),
                                  Text('${_emotionController.monthMoodCount[1]}',
                                      style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                          fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.moodBad)),
                                ],
                              ),
                              Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 5),
                                    child: Image(image: moodMap['Neutral']!.icon, width: 42.0),
                                  ),
                                  Text('${_emotionController.monthMoodCount[2]}',
                                      style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: Theme.of(context).colorScheme.moodNeutral)),
                                ],
                              ),
                              Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 5),
                                    child: Image(image: moodMap['Happy']!.icon, width: 42.0),
                                  ),
                                  Text('${_emotionController.monthMoodCount[3]}',
                                      style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                          fontWeight: FontWeight.w600, color: Theme.of(context).colorScheme.moodHappy)),
                                ],
                              ),
                              Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(vertical: 5),
                                    child: Image(image: moodMap['VeryHappy']!.icon, width: 42.0),
                                  ),
                                  Text('${_emotionController.monthMoodCount[4]}',
                                      style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                          fontWeight: FontWeight.w600,
                                          color: Theme.of(context).colorScheme.moodVeryHappy)),
                                ],
                              ),
                            ],
                          ),
                  ...
                  const ScoreCards(
                      title: 'Your latest PHQ-9 score for this month', score: 5, total: 28, link: '/phqStatScreen'),
                  const SizedBox(height: 20),
                  const ScoreCards(
                      title: 'Your latest Suicidal Ideation score for this month',
                      score: 34,
                      total: 50,
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(context)
                .textTheme
                .bodyMedium
                ?.copyWith(fontWeight: FontWeight.w400, color: Theme.of(context).colorScheme.neutralGray01),
          ),
          const SizedBox(height: 10),
          const Divider(
            color: Color(0xffF0F1F1),
