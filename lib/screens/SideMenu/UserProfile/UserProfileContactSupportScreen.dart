...
class _UserProfileContactSupportScreenState
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                        ...
                        decoration:
                            textFormFieldDecoration('Enter your message here'),
                        validator: (input) {
  ...
  Future<void> sendMessage() async {
    final Email email = Email(
      ...
      subject: 'Feedback about Kasiyanna',
      recipients: ['2193079@slu.edu.ph'],
    ...
    Get.snackbar('Contact Developers Email', platformResponse);
  }
}
