...
class LoadingResultsScreenWidget extends StatefulWidget {
  ...
  @override
  State<LoadingResultsScreenWidget> createState() => _LoadingResultsScreenState();
}
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Image.asset('assets/images/flower_filled.png', ),
            ),
            const SizedBox(
              height: 30.0,
            ),
            const Text('Your results for your first evaluation is ready!',
              style: TextStyle(
                fontSize: 20,
                fontFamily: 'Proxima Nova',
                fontWeight: FontWeight.w600,
