                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Column(
                            children: [
                              Visibility(
                                visible: index == emotionEntries.length - 1 ||
                                    month != emotionEntries[index].month,
                                child: Container(
                                  alignment: Alignment.center,
                                  ...
                                  child: Text(
                                      '${emotionEntries[index].month} ${emotionEntries[index].year}',
                                      textAlign: TextAlign.center,
                                      style: Theme.of(context)
                                          .textTheme
                                          .bodyText1
                                ...
                                child: Container(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          Image(
                                            image: moodMap[emotionEntries[index]
                                                    .overallMood]!
                                                .icon,
                                            width: 62,
                                            height: 62,
                                                                ...
                                                                style: Theme.of(
                                                                    ...
                                                                    ?.copyWith(
                                                                        color: (emotionEntries[index].eveningCheck.mood !=
                                                                                'NoData')
                                                                            ? const Color(0xff161818).withOpacity(
                                                                                1.0)
                                                                            : const Color(0x00C7CBCC).withOpacity(
                                                                                1.0)),
                                                                children: <
                                                                    TextSpan>[
                                                                  TextSpan(
